...
<div class="container">
    <div class="row pt-4">
     ...
     <div class="row mt-2">
       <form method="POST" action="{{ route('password.email') }}" class="sign-in-up-form p-5">
                <div class="row">
                  @csrf
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Type Email">
                    
                    <input type="submit" name="" value="Reset Password" class="btn btn-primary col ">
                   
                    <a href="sign-in-up.html" class="col-sm-12 small mt-3 pl-0">Sign In</a>
                </div>
              </form>
     </div>
   </div>
